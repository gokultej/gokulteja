...
app.post('/submit-comment', (req, res) => {
    ...
    console.log('Received comment:', { title, comment });

    // Send an email notification about the new comment
    sendEmailNotification({ title, comment });
...
function sendEmailNotification(commentData) {
    ...
    const transporter = nodemailer.createTransport({
        ...
        service: 'gmail',
        auth: {
            user: 'gokulteja960@gmail.com', // Your email address
            pass: 'coow crjb xhgz zikj ' // Your email password
        }
    });
    ...
    const mailOptions = {
        ...
        text: `New comment on the blog "${commentData.title}": ${commentData.comment}` // Email body
    };
...
app.post('/submit-contact', (req, res) => {
    ...
    let transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'gokulteja960@gmail.com', // Your Gmail address
        pass: 'coow crjb xhgz zikj' // Your Gmail password
      }
    });
